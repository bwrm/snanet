# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2018-11-12 04:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discont_scheme', models.TextField(help_text='Type discont scheme: first- quantity? second- rebate in %. Example: 10:25 - 10 -quantity 25%', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Manufacturer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discont_scheme', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='myshop.Discount')),
            ],
            options={
